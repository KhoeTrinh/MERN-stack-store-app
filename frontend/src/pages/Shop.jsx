        ...
        <>
            <div className='container mx-auto'>
                <div className='flex md:flex-row'>
                    <div className='p-3 bg-gray-300 mt-2 mb-2'>
                        <h2 className='h4 text-center py-2 bg-gray-100 rounded-full mb-2 p-3'>
                        ...
                        <h2 className='h4 text-center py-2 bg-gray-100 rounded-full mb-2'>
                            Filter by Brands
                        </h2>
