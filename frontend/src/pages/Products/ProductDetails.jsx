                    ...
                    <div
                        ...
                        <div>
                            <img
                                ...
                                md:mb-[2rem] sm:mb-[2rem] aspect-square'
                            />
                        ...
                        <div
                            ...
                            <h2
                                className='xl:text-2xl lg:text-xl md:text-2xl 
                                    sm:text-3xl font-semibold'>
                                {product.name}
                            </h2>
                            <p
                                className='my-4 xl:[35rem] lg:w-[25rem] 
                                    md:w-[25rem] sm:w-[25rem]'>
                                {product.description}
                            </p>
                            <p
                                className='xl:text-5xl lg:text-2xl md:text-4xl 
